<template>
	<view class="logo" :style="{ backgroundImage: 'url(' + '/static/bg.png' + ')' }">
		...
		<view class="text-area">
			...
			<input class="title3" type="password" v-model="passwd" placeholder="请输入密码"></input>
		</view>
		<view>
			<view class="text-area">
				<text class="title">确认密码</text>
				<input type="password" v-model="twoPasswd" class="title3" placeholder="请确认密码"></input>
			</view>
			<button class="denglu" @tap="zhuce">注册</button>
