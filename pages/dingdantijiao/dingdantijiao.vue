	...
	<view>
			<view class="beijing">
				...
				<view class="baidi1">
					...
					<!-- 直接购买的详情包括砍价拼团 -->
					<view class="heng1" v-if="goods_types*1 === 0||goods_types*1 === 2||goods_types*1 === 3||goods_types*1 === 4">
						<view class="aaaaaaa">
					...
					<view class="heng1" v-if="goods_types*1 ===6"><!-- 二手好货的详情 -->
						<view class="aaaaaaa">
					...
					<view class="heng">
						...
						<image :src="current == true?require('../../static/shouhuodizhi/iocn-27-gou.png'):require('../../static/zhibo/iocn-105-wx.png')"
					...
					<view class="heng">
						...
						<image :src="current1 == true?require('../../static/shouhuodizhi/iocn-27-gou.png'):require('../../static/zhibo/iocn-105-wx.png')"
		...
		export default {
			...
			methods: {
				...
				changebinggo(i) {
					...
					if (this.current == true) {
						this.current = false //支付宝
						this.current1 = true //微信
						return
					} else {
						this.current = true //支付宝
						this.current1 = false //微信
						return
					}
					// if(i == 0){
					// 	if(this.current == true){
