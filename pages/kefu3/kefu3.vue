<template>
	<view>
		...
		<view class="xj">
			<image class="xj1" src="../../static/kefu/iocn-25-xj.png" mode=""></image>
			<image class="xj1" src="../../static/kefu/iocn-25-xc.png" mode=""></image>
		</view>
		<view class="xj">
			<view class="xjzi">相机拍摄</view>
			<view class="xjzi">相册上传</view>
